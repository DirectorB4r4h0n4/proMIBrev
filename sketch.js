...
function preload(){
  ...
  trex_running = loadAnimation("trex_2.png","trex_1.png","trex_3.png","trex_4.png","trex_5.png","trex_6.png","trex_7.png","trex_8.png");
  trex_collided = loadAnimation("trex_collided.png");
  alien_running = loadAnimation("alien_1.png","alien_2.png","alien_3.png","alien_4.png","alien_5.png","alien_6.png","alien_7.png","alien_8.png");
...
function setup() {
  ...
  alien = createSprite(500,height-100,50,50);

  alien.addAnimation("running", alien_running);
  alien.setCollider('circle',0,0,350)
  alien.scale = 0.40
